 ...
 */
P2PAPI_API int
IOTC_Device_Login(const char *cszUID, const char *cszDeviceName, const char *cszDevicePWD);
 ...
 */
P2PAPI_API int
IOTC_Device_LoginNB(const char *cszUID, const char *cszDeviceName, const char *cszDevicePWD,
 ...
 */
P2PAPI_API int IOTC_Session_Read_Check_Lost(int nIOTCSessionID, char *abBuf, int nMaxBufSize,
                                            unsigned int nTimeout, unsigned short *pnPacketSN,
                                            char *pbFlagLost, unsigned char nIOTCChannelID);
 ...
 */
P2PAPI_API int
IOTC_Session_Check_ByCallBackFn(int nIOTCSessionID, sessionStatusCB pfxSessionStatusFn);
 ...
 */
P2PAPI_API int
IOTC_Session_Read(int nIOTCSessionID, char *abBuf, int nMaxBufSize, unsigned int nTimeout,
 ...
 *
 */
P2PAPI_API int IOTC_Session_Write(int nIOTCSessionID, const char *cabBuf, int nBufSize,
                                  unsigned char nIOTCChannelID);
 ...
 */
P2PAPI_API int
IOTC_Lan_Search(struct st_LanSearchInfo *psLanSearchInfo, int nArrayLen, int nWaitTimeMs);
 ...
 */
P2PAPI_API int
IOTC_Lan_Search2(struct st_LanSearchInfo2 *psLanSearchInfo2, int nArrayLen, int nWaitTimeMs);
 ...
 */
P2PAPI_API int
IOTC_Lan_Search2_Ex(struct st_LanSearchInfo2 *psLanSearchInfo2, int nArrayLen, int nWaitTimeMs,
                    int nSendIntervalMs);
...
*/
P2PAPI_API int
IOTC_Search_Device_Result(struct st_SearchDeviceInfo *psSearchDeviceInfo, int nArrayLen,
                          int nGetAll);
...
*
*/
P2PAPI_API int IOTC_Session_Write_Reliable_NB(int nIOTCSessionID, const char *cabBuf, int nBufSize,
                                              unsigned char nIOTCChannelID);
...
**/
P2PAPI_API int
IOTC_Session_Write_Reliable_NB_Abort(int nIOTCSessionID, unsigned char nIOTCChannelID);
